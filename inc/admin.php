	...
	'ms-element-conditions'	=> [ // option name
		...
		'sections' => [
			'section-main'	=> [
				...
				'text'			=> '<p>' . __( 'Click on elements with this selectors will setup cookie and widget visibility logic will based on it. This classes or id must be same as in corresponding buttons in disclaimer popups. After each click cookie will be overwriten.', 'ms_element_conditions' ) . '</p>',
				'fields'	=> [
					'private' => [
